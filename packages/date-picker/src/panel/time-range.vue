    ...
    <div
      ...
      <div class="el-time-range-picker__content">
        <div class="el-time-range-picker__cell">
          ...
          <div
            :class="{ 'has-seconds': showSeconds, 'only-hours': !showMinutes, 'is-arrow': arrowControl }"
...
<script type="text/babel">
  ...
  export default {
    ...
    computed: {
      ...
      offset() {
        return this.showSeconds ? 11 : (this.showMinutes ? 8 : 5);
      },
    ...
    methods: {
      ...
      changeSelectionRange(step) {
        ...
        const minPositions = [0]
          .concat(this.showMinutes ? [3] : [])
          .concat(this.showSeconds ? [this.showMinutes ? 6 : 3] : []);
        const maxPositions = minPositions.map(p => p + this.offset);
        const list = minPositions.concat(maxPositions);
