...
export declare class ElTable extends ElementUIComponent {
  ...
  /** Whether current column is highlighted */
  highlightCurrentColumn: boolean

  /** Key of current highlighted column (columnKey/prop/label/id) */
  ...
  /** Set a certain column as current highlighted column */
  setCurrentColumn (columnKey: string): void
  
  /** Hide a column by key (columnKey/prop/label/id) */
  hideColumn (key: string | object): void

  /** Show a column by key (columnKey/prop/label/id) */
  showColumn (key: string | object): void

  /** Toggle a column's visibility by key (columnKey/prop/label/id) */
  toggleColumn (key: string | object): void
