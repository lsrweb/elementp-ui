...
export interface ElMessage {
  ...
  /** Grouped singleton message: repeated calls with same key reuse one instance and increase count */
  group (key: string, options: ElMessageOptions): ElMessageComponent

  /** Close a grouped singleton by key */
